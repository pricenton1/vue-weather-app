<template>
  <div class="container-xl">
    <h1 class="font-sans text-4xl font-bold tracking-wide text-blue-500 text-center" :class="[bgColor]">
      Weather App
    </h1>

    <section class="flex w-auto h-48 mx-auto " :class="[bgColor]">

      <div class="flex-initial w-3/4 h-40 bg-contain" :class="[skyRender]">
      </div>
      ...
      <div class="flex-initial w-1/4 rounded-md">
        ...
        <img class="w-48" :src="require(`../assets/images/icons/${dayNight}.svg`)" alt="iconDayNight">
      </div>
    ...
    <div class="container-xl h-max" :class="[bgColor]">
      <div 
        v-if="dataWeather.cod === 200"
        class="w-full h-max bg-repeat-x bg-auto bg-left bg-clip-content bg-[url('../assets/images/city.png')]">
        <CardComp class="mx-auto" />
      </div>
      <div 
        v-else
